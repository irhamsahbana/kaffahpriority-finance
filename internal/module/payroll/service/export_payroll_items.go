...
func (s *payrollService) ExportPayrollItemsPeriodically(ctx context.Context, req *entity.ExportPayrollItemsPeriodicallyReq) (*entity.ExportPayrollItemsPeriodicallyResp, error) {
	...
	// Headering
	_ = f.SetCellValue(sheetName, "A1", "NO")
	_ = f.SetCellValue(sheetName, "B1", "NAMA")
	_ = f.SetCellValue(sheetName, "C1", "NO")
	_ = f.SetCellValue(sheetName, "D1", "NAMA")
	_ = f.SetCellValue(sheetName, "E1", "PROGRAM")
	_ = f.SetCellValue(sheetName, "F1", "JUMLAH")
	_ = f.SetCellValue(sheetName, "G1", "HITUNGAN")
	_ = f.SetCellValue(sheetName, "H1", "UJROH FULL")
	_ = f.SetCellValue(sheetName, "I1", "UJROH AWAL")
	...
	_ = f.SetColWidth(sheetName, "N", "N", 20)
